 ...
 *   - paymentHints  – optional [{type,value,label?}] from validated manifest.payment_hints
 *   - integrationsPublic – optional { discovery_opt_in, developer_webhooks_count }
 *
...
function buildCertBody({
    ...
    paymentHints, integrationsPublic,
}) {
    ...
    return {
        ...
        credentialSubject: {
            ...
            payment_hints: Array.isArray(paymentHints) ? paymentHints : [],
            integrations: integrationsPublic && typeof integrationsPublic === 'object'
                ? {
                    discovery_opt_in: !!integrationsPublic.discovery_opt_in,
                    developer_webhooks_count: Number(integrationsPublic.developer_webhooks_count) || 0,
                }
                : {
                    discovery_opt_in: false,
                    developer_webhooks_count: 0,
                },
            payment_proof: {
